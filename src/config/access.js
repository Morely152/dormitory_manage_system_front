...
export const ACCESS_MODULES = Object.freeze([
  ...
  },
  {
    ...
    path: '/accommodation/change-records',
    title: '住宿信息变更日志',
  ...
  },
  {
    ...
    title: '住宿信息修改申请（含转专业信息修改）',
    description: '提交学生住宿信息及转专业后的学院、专业等信息更新，宿管中心审核后生效',
    group: '申请处理',
    icon: 'Edit',
  ...
  },
  {
    ...
    path: '/confirmations/error-correction-review',
    title: '有误信息纠正审核',
    description: '集中审核学生反馈的住宿信息错误并处理纠正申请',
    group: '纠正审核',
    icon: 'WarningFilled',
