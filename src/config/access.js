...
export const ACCESS_MODULES = Object.freeze([
  ...
  },
  {
    ...
    title: '报修汇总',
    description: '汇总查看所有报修问题及当前处理进度。',
    group: '维修报修服务',
    workspaceGroup: '维修报修服务',
    workspaceGroupOrder: 1,
    workspaceOrder: 4,
    icon: 'Document',
    operation: 'query',
  ...
  {
    id: 'repair-work-order-management',
    subsystem: SUBSYSTEM_KEYS.MAINTENANCE,
    routeName: 'RepairWorkOrderManagement',
    path: '/maintenance/work-orders/create',
    legacyPaths: ['/maintenance/work-orders/pending-review'],
    title: '工单创建与待审核',
    description: '创建维修工单，并查看已提交或需修改的工单。',
    group: '工单流转',
    workspaceGroup: '工单流转',
    workspaceGroupOrder: 2,
    workspaceOrder: 1,
  ...
  },
  {
    ...
    subsystem: SUBSYSTEM_KEYS.SYSTEM,
    routeName: 'NotificationAnnouncement',
    path: '/system/notification-announcements',
    title: '信息通知管理',
    description: '发布、编辑和撤回面向全体或指定角色的通知公告。',
    group: '系统管理',
    icon: 'Bell',
    operation: 'edit',
    roles: [ROLE_KEYS.SYSTEM_ADMIN, ROLE_KEYS.DORMITORY_ADMIN],
